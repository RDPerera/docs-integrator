...
3. Assign the security roles required for the tax region entities you plan to work with (for example, **Tax accountant** or **Tax administrator**, plus any country/region-specific tax roles) and save.
