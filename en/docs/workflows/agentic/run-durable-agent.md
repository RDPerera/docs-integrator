...
- [Workflow executions](../icp/executions.md) — watching the started instance and deciding what it escalates.
- [Build a Claim Handling Durable Agent](../getting-started/build-claim-handling-agent.md) — the same agent driven end to end.
